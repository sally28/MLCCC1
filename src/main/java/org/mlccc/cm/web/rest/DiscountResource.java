...
public class DiscountResource {
    ...
    public ResponseEntity<Discount> createDiscount(@Valid @RequestBody Discount discount) throws URISyntaxException {
        ...
        if (discount.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new discount cannot already have an ID")).body(null);
        }
        try{
            ...
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "duplicate", "A discount already exists")).body(null);
        }
    }
    ...
    public ResponseEntity<Discount> getDiscount(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(discount));
    }
